namespace FDViewer
{
    partial class frmFDViewer
    {
        ...
        private void InitializeComponent()
        {
			...
			this.dgvFD.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle4;
			...
			this.dgvFD.RowHeadersDefaultCellStyle = dataGridViewCellStyle5;
			...
			this.dgvFD.RowsDefaultCellStyle = dataGridViewCellStyle6;
